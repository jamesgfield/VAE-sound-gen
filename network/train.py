...
def load_mnist():
    ...
    x_train = x_train.astype("float32") / 255 # normalise grey scale samples between 0->1
    x_train = x_train.reshape(x_train.shape + (1,)) # add extra dimension to samples (channel dimension)
